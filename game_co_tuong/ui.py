...
class CoTuongGUI:
    ...
    def man_hinh_chon_che_do(self):
        ...
        # ĐÃ SỬA: Giữ lại ảnh nền cho màn hình Chọn chế độ
        if self.bg_image:
            bg_label = tk.Label(self.khung_giao_dien, image=self.bg_image)
            bg_label.place(x=0, y=0, relwidth=1, relheight=1)
            
        # ĐÃ SỬA: Tạo khung trung tâm nổi bật trên nền ảnh và căn giữa
        ...
        btn_1vs1 = tk.Button(khung_trung_tam, text="⚔️   Chế Độ 1 VS 1   ⚔️\n(Chơi đối kháng offline)", font=("Arial", 14, "bold"),
                             ...
                             bd=2, relief=tk.SOLID, width=24, height=3, cursor="hand2", highlightthickness=0,
    ...
    def man_hinh_nhap_ten(self):
        ...
        # ĐÃ SỬA: Giữ lại ảnh nền cho màn hình Nhập tên
        if self.bg_image:
            bg_label = tk.Label(self.khung_giao_dien, image=self.bg_image)
            bg_label.place(x=0, y=0, relwidth=1, relheight=1)
            
        # ĐÃ SỬA: Tạo một Khung trung tâm bọc toàn bộ form nhập tên để căn GIỮA tuyệt đối và đẹp mắt
        ...
        # Thêm justify="center" để chữ nhập vào tự động ở giữa thanh
        ent_p1 = tk.Entry(frame_p1, textvariable=self.var_ten1, font=("Arial", 12), justify="center", bg="#f1f2f6", bd=1, relief=tk.SOLID)
        ent_p1.pack(fill=tk.X, ipady=8)
        
        # _Phần nhập tên Người chơi 2
        ...
        ent_p2 = tk.Entry(frame_p2, textvariable=self.var_ten2, font=("Arial", 12), justify="center", bg="#f1f2f6", bd=1, relief=tk.SOLID)
        ent_p2.pack(fill=tk.X, ipady=8)
        
        # Nút bấm bắt đầu trận đấu
        self.btn_choi = tk.Button(khung_trung_tam, text="Bắt Đầu Trận Đấu", font=("Arial", 13, "bold"),
