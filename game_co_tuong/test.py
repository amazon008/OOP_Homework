...
class CoTuongGUI:
    ...
    def man_hinh_chon_che_do(self):
        ...
        # Giữ lại ảnh nền cho màn hình Chọn chế độ
        if self.bg_image:
            bg_label = tk.Label(self.khung_giao_dien, image=self.bg_image)
            bg_label.place(x=0, y=0, relwidth=1, relheight=1)
            
        # Tạo khung trung tâm nổi bật trên nền ảnh và căn giữa
    ...
    def man_hinh_nhap_ten(self):
        ...
        # Giữ lại ảnh nền cho màn hình Nhập tên
        if self.bg_image:
            bg_label = tk.Label(self.khung_giao_dien, image=self.bg_image)
            bg_label.place(x=0, y=0, relwidth=1, relheight=1)
            
        # Khung trung tâm bọc toàn bộ form nhập tên để căn GIỮA
        ...
        # ĐÃ SỬA: Ô nhập liệu P1 - Đổi sang thiết kế phẳng, viền highlight khi click
        ...
        # ĐÃ SỬA: Ô nhập liệu P2 - Đổi sang thiết kế phẳng, viền highlight khi click
        ...
        # ĐÃ SỬA: Bắt sự kiện phím Enter
        # Khi ấn Enter ở ô 1 -> Nhảy sang ô 2
        self.ent_p1.bind("<Return>", lambda event: self.ent_p2.focus())
        
        # Khi ấn Enter ở ô 2 -> Gọi hàm kiểm tra và vào trận nếu tên hợp lệ
        self.ent_p2.bind("<Return>", self.kiem_tra_va_vao_tran)

        # Focus sẵn vào ô P1 khi mới mở màn hình
        self.ent_p1.focus()
        
    def kiem_tra_va_vao_tran(self, event=None):
        """Hàm xử lý khi nhấn Enter ở ô P2"""
